...
const calculations_DO_NOT_CHANGE = (list1: number[][]): number[] => {
  const list2: number[] = [];
 ...
 * Your changes chould not go above and beyond the answers to these questions. If your hands are
 * burning to refactor something, write it down.
 *
 * You may rename functions, and create new variable bindings, but nothing else!
 */

const calculations_PLEASE_CHANGE = (list1: number[][]): number[] => {
  const list2: number[] = [];
